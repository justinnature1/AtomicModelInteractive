...
public class ElectricalCollision extends Move {
	...
	public void setAcceleration(Particle neighbor) {
		...
		this.xAcc = Physics.acceleration(Physics.xComponent(force, radians),particle.mass);
		this.yAcc = Physics.acceleration(Physics.yComponent(force, radians),particle.mass);
	}
